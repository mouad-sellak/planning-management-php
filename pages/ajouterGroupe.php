...
if ( isset($_POST['valider'])  ){
    ...
    $idregion = $tab['id'];
    $Requete ="INSERT INTO groupes(nom_groupe,image,id_region) VALUES( '$nom','$nomPhoto','$idregion')";
    $Resultat=$pdo->query($Requete);                                        
    $alert="<div class='alert alert-success'><b>Le groupe est ajouté avec succès !</b></div>";
    header("refresh:2;url=groupes.php" );
} 
?>
<!DOCTYPE html>
<html>
    ...
    <div class="container col-md-6 col-md-offset-3 ">
        <div class="panel panel-info " style=" margin-top:100px; text-align:center;">
            <div class="panel-heading">
                <h3><strong>Ajouter Groupe</strong></h3>
            </div>
